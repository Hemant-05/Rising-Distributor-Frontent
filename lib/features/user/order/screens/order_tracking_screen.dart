...
class _OrderTrackingScreenState extends State<OrderTrackingScreen> {
  ...
  Future<void> _refreshOrder() async {
    ...
    final updatedOrder = await context
        .read<OrderService>()
        .fetchOrderById(orderId, showLoader: false);
  ...
  Widget build(BuildContext context) {
    final status = _order.status?.toUpperCase() ?? OrderStatusPlaced;
    final isCancelled = status == OrderStatusCancelled;
            ...
            children: [
              ...
              if (isCancelled)
                Container(
                  ...
                  child: Column(
                    children: [
                      ...
                      Text(
                        _order.cancelReason ?? 'No reason provided',
                        textAlign: TextAlign.center,
                        style: simple_text_style(
                          fontSize: 14,
                ...
                Container(
                  ...
                  child: _buildStepperTimeline(status),
                ),
            ],
          ),
        ),
  ...
  Widget _buildStepperTimeline(String currentStatus) {
    final statuses = [
      ...
      },
      {
        ...
        'desc': 'Seller is packing your items',
      },
      {
